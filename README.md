...
body {
  ...
  background: linear-gradient(to bottom right, #ffd6e7, #ff4f81);
...
#yesBtn {
  ...
  background:linear-gradient(to right, #ff2e63, #ff0844);

  box-shadow:0 0 15px rgba(255,0,70,0.6);
...
#yesBtn:hover {
  ...
  box-shadow:0 0 25px rgba(255,0,70,0.9);
